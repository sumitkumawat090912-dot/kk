...
OWNER_ID = 6053889491 # Replace with the actual owner's user ID

# List of sudo users (initially empty or pre-populated)
SUDO_USERS = [6053889491,1727542582,6303334633]

AUTH_CHANNEL = -1003295301650
